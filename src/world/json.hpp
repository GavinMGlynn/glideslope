...
// JSON (RFC 8259), read into a tree: for the weather services' responses.
//
// Written here rather than linked, as DEFLATE was: reading JSON is short and
// completely specified, and what the weather needs is to read small documents,
// not to write or stream them. Strict: what RFC 8259 does not allow - trailing
