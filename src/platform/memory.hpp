...
// is trimmed at the system's whim, and would hide growth), and the physical
// footprint on macOS (task_info's TASK_VM_INFO: the resident size misses
// memory the system has compressed). Nothing when the system will not say.
//
